...
// Global variable to store the cropped image data
  ...
  reader.onload = function(event) {
    ...
    img.onload = function() {
      ...
      setTimeout(() => {
        ...
        // Use the cropped dimensions if available (200x200)
        canvas.width = 200;
        canvas.height = 200;

        const ctx = canvas.getContext('2d');
        
        // Draw the image - the cropping has already been handled by the cropper component
        ...
        document.getElementById('webp-dimensions').textContent = '200 × 200px';
